...
class User(Base):
    ...
    remodeler_labor_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    plumber_labor_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    tinner_labor_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    electrician_labor_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    designer_labor_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
...
class CatalogItem(Base):
    ...
    labor_trade: Mapped[str] = mapped_column(String(32), default="remodeler")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow)
...
class EstimateLineItem(Base):
    ...
    labor_hours: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    remodeler_labor_hours: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    plumber_labor_hours: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    tinner_labor_hours: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    electrician_labor_hours: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    designer_labor_hours: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
    labor_trade: Mapped[str] = mapped_column(String(32), default="remodeler")
    labor_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=Decimal("0"))
