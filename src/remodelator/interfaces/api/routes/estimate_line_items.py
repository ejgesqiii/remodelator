    ...
    def action() -> dict[str, Any]:
        with session_scope() as session:
            return service.add_line_item(
                ...
                remodeler_labor_hours=payload.remodeler_labor_hours,
                plumber_labor_hours=payload.plumber_labor_hours,
                tinner_labor_hours=payload.tinner_labor_hours,
                electrician_labor_hours=payload.electrician_labor_hours,
                designer_labor_hours=payload.designer_labor_hours,
